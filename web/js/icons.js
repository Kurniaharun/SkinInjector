/** Lucide-style SVG icons (inline, no CDN). */
const SVG_ATTR = 'xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"';
...
export function icon(name, cls = "") {
  ...
  return `<svg ${SVG_ATTR}${extra} aria-hidden="true">${paths}</svg>`;
}

export function iconBox(name, variant = "") {
  return `<span class="icon-box ${variant}">${icon(name, "icon-svg")}</span>`;
}
